                            ...
                            <div class="flex item-center justify-center">
                                ...
                                <form action="{{ route('tickets.archive', $ticket->id) }}" method="POST" class="inline-block">
                                    ...
                                    <button type="submit" class="w-4 mr-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <path fill="#8B4513" d="M32 32H480c17.7 0 32 14.3 32 32V96c0 17.7-14.3 32-32 32H32C14.3 128 0 113.7 0 96V64C0 46.3 14.3 32 32 32zm0 128H480V416c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V160z" />
                                        </svg>
                                    </button>
                                </form>
                                @endif
